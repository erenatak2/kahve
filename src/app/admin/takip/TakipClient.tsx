...
import { Phone, Check, Search, MessageCircle, AlertCircle, X, Save, MapPin } from 'lucide-react'
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="hidden sm:table-cell">Bölge</TableHead>
              ...
              {filtered.map((r: any) => (
                <TableRow key={r.id}>
                  ...
                  <TableCell className="hidden sm:table-cell">
                    {r.region ? (
                      <span className="flex items-center gap-1.5 text-xs font-bold text-gray-600 bg-gray-50 border border-gray-100 px-2.5 py-1 rounded-full w-fit capitalize">
